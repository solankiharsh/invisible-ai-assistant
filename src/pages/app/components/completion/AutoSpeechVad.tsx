...
import { shouldUseCloakAPI } from "@/lib/functions/cloak.api";
  ...
  const vad = useMicVAD({
    ...
    onSpeechEnd: async (audio) => {
      try {
        ...
        if (!selectedSttProvider.provider && !useCloakAPI) {
        ...
        transcription = await fetchSTT({
          provider: useCloakAPI ? undefined : providerConfig,
