...
export const Audio = ({
  ...
  const { selectedSttProvider, cloakApiEnabled, selectedAudioDevices } =
    useApp();
  ...
  return (
    <Popover open={micOpen} onOpenChange={setMicOpen}>
      <PopoverTrigger asChild>
        {(cloakApiEnabled || speechProviderStatus) && enableVAD ? (
          <AutoSpeechVAD
      ...
      <PopoverContent
        ...
        side="bottom"
        className={`w-80 p-3 ${
          cloakApiEnabled || speechProviderStatus ? "hidden" : ""
        }`}
        sideOffset={8}
      >
